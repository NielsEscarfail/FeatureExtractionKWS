...
if __name__ == '__main__':
    ...
    test_acc, run_test_sample_time = training_environment.validate(model=model, mode='testing', batch_size=512)
    val_acc, run_val_sample_time = training_environment.validate(model=model, mode='validation', batch_size=512)
