...
python train_ofa_net.py --task width --phase 1 --ft_extr_type mfcc 2>&1 | tee term_logs/mfcc_depth2width1.txt
python train_ofa_net.py --task width --phase 2 --ft_extr_type mfcc 2>&1 | tee term_logs/mfcc_depth2width2.txt
python train_ofa_net.py --task width --phase 3 --ft_extr_type mfcc 2>&1 | tee term_logs/mfcc_depth2width3.txt
